...
const index = () => {
  ...
  return (
    <main className={styles["main-video-player"]} id="video-content">
      <section className={styles["player"]}>
        ...
        <div className={styles["controls"]}>
          <div className={styles["btn-play"]} id="play-btn">
            <BsPlayCircleFill
              color="#ffffff"
          ...
          <div className={`${styles["btn-pause"]} displayNone`} id="pause-btn">
            <BsPauseCircleFill
          ...
          <div className={styles["btn-restart"]} id="restart-btn">
            <BsReplyFill
          ...
          <div className={styles["btn-volume"]}>
            <BsSoundwave
              id="volume-icon"
